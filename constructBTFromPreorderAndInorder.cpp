...
public:
    TreeNode* buildTree(vector<int>& preorder, vector<int>& inorder) {
        ...
        TreeNode* node = construct(preorder, 0, preorder.size()-1,
    ...
    TreeNode* construct(vector<int>& preorder,int preStart, int preEnd,
        ...
        node -> left = construct(preorder, preStart + 1, preStart+ numLeft,
                                    inorder, inStart, inRoot - 1, mp);
        node -> right = construct(preorder, preStart + numLeft + 1, preEnd,
